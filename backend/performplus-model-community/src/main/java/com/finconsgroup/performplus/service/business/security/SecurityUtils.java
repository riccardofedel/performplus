...
public final class SecurityUtils {
    ...
    public static Optional<String> getCurrentUserLogin() {
        ...
        return Optional.ofNullable(securityContext.getAuthentication())
            .map(authentication -> {
                if (authentication.getPrincipal() instanceof UserDetails ele) {
                    UserDetails springSecurityUser = ele;
                    return springSecurityUser.getUsername();
                } else if (authentication.getPrincipal() instanceof String ele) {
                    return ele;
                }
                return null;
            });
    ...
    public static Ruolo ruolo(final IUtenteBusiness utenteBusiness, final Integer anno) {
		Authentication auth = SecurityContextHolder.getContext().getAuthentication();
		String username = auth.getName();
		UtenteVM utente = utenteBusiness.leggiPerUserid(username);
		if (utente!=null && utente.getProfili() != null && !utente.getProfili().isEmpty()) {
